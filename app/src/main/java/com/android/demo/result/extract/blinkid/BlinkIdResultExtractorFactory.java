package com.android.demo.result.extract.blinkid;

import com.android.demo.result.extract.blinkid.australia.AustralianDLBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.australia.AustralianDLFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.austria.AustriaDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.austria.AustrianIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.austria.AustrianIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.austria.AustrianIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.austria.AustrianPassportRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.brunei.BruneiIdBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.brunei.BruneiIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.brunei.BruneiResidencePermitBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.brunei.BruneiResidencePermitFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.colombia.ColombiaDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.colombia.ColombiaIDBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.colombia.ColombiaIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.croatia.CroatianIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.croatia.CroatianIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.croatia.CroatianIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.cyprus.CyprusIdBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.cyprus.CyprusIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.cyprus.CyprusOldIdBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.cyprus.CyprusOldIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.czechia.CzechIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.czechia.CzechIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.czechia.CzechIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.documentface.DocumentFaceRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.egypt.EgyptIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.elitepaymentcard.ElitePaymentCardBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.elitepaymentcard.ElitePaymentCardCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.elitepaymentcard.ElitePaymentCardFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.eudl.EUDriversLicenceRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanDLBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanOldIDRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanPassportRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.germany.GermanyDlFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.hongkong.HongKongIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.indonesia.IndonesianIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.ireland.IrelandDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.italy.ItalyDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.jordan.JordanIDBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.jordan.JordanIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.jordan.JordanIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.kuwait.KuwaitIdBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.kuwait.KuwaitIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaDLFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaIKadFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaMyKadFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaMyKasFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaMyPrFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MalaysiaMyTenteraRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.malaysia.MyKadBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.mexico.MexicoVoterIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.morocco.MoroccoIdBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.morocco.MoroccoIdFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.mrtd.MRTDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.mrtd.MrtdRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.newzealand.NewZealandDLFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.paymentcard.PaymentCardBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.paymentcard.PaymentCardCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.paymentcard.PaymentCardFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.poland.PolishIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.poland.PolishIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.poland.PolishIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.romania.RomanianIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.serbia.SerbianIDBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.serbia.SerbianIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.serbia.SerbianIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.singapore.SingaporeChangiEmployeeIdRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.singapore.SingaporeCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.singapore.SingaporeDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.singapore.SingaporeIDBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.singapore.SingaporeIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovakia.SlovakIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovakia.SlovakIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovakia.SlovakIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovenia.SlovenianIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovenia.SlovenianIDCombinedRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.slovenia.SlovenianIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.spain.SpainDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.sweden.SwedenDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.switzerland.SwissDLFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.switzerland.SwissIDBackSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.switzerland.SwissIDFrontSideRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.switzerland.SwissPassportRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.unitedArabEmirates.UnitedArabEmiratesDlFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.unitedArabEmirates.UnitedArabEmiratesIDBackRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.unitedArabEmirates.UnitedArabEmiratesIDFrontRecognitionResultExtractor;
import com.android.demo.result.extract.blinkid.usdl.USDLCombinedResultExtractor;
import com.android.demo.result.extract.blinkinput.BlinkInputResultExtractorFactory;
import com.android.demo.result.extract.usdl.USDLResultExtractor;
