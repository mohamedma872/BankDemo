...
/**
 * Created by igor on 1/9/15.
 */
public class LibResultConstants {
    ...
    /** Key for raw PhotoMath data */
    public static final String RAW_PHOTOMATH_DATA = "RawPhotoMathData";
    ...
    // mrtd recognition result constants
